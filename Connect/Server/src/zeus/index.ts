...
export type ValueTypes = {
	...
	["PublicMutation"]: AliasType<{
		register?: [
			{ username: string | Variable<any, string>; password: string | Variable<any, string> },
			ValueTypes["AuthPayload"]
		];
		login?: [
			{ username: string | Variable<any, string>; password: string | Variable<any, string> },
			ValueTypes["AuthPayload"]
	...
	["SalonOps"]: AliasType<{
		createService?: [
			{ service: ValueTypes["CreateService"] | Variable<any, string> },
			boolean | `@${string}`
		];
		serviceOps?: [{ _id: string | Variable<any, string> }, ValueTypes["ServiceOps"]];
		update?: [
			{ salon: ValueTypes["UpdateSalon"] | Variable<any, string> },
			ValueTypes["RegisterResponse"]
		];
		delete?: boolean | `@${string}`;
		createVisit?: [
			{ visit: ValueTypes["CreateVisitFromAdmin"] | Variable<any, string> },
			boolean | `@${string}`
		];
		visitOps?: [{ _id: string | Variable<any, string> }, ValueTypes["VisitOps"]];
		sendMessage?: [
			{
				salonClientId: string | Variable<any, string>;
				message: ValueTypes["MessageInput"] | Variable<any, string>;
			},
			boolean | `@${string}`
		];
		__typename?: boolean | `@${string}`;
	...
	["SalonClient"]: AliasType<{
		...
		visits?: [
			{
				filterDates: ValueTypes["DateFilter"] | Variable<any, string>;
				salonId?: string | undefined | null | Variable<any, string>;
			},
			ValueTypes["Visit"]
		];
		_id?: boolean | `@${string}`;
	...
	["ServiceOps"]: AliasType<{
		delete?: boolean | `@${string}`;
		update?: [
			{ service: ValueTypes["UpdateService"] | Variable<any, string> },
			boolean | `@${string}`
		];
		__typename?: boolean | `@${string}`;
	}>;
	...
	["VisitOps"]: AliasType<{
		update?: [
			{ visit: ValueTypes["UpdateVisitFromAdmin"] | Variable<any, string> },
			ValueTypes["VisitResponse"]
		];
		delete?: boolean | `@${string}`;
		__typename?: boolean | `@${string}`;
	}>;
	...
	["UserOps"]: AliasType<{
		registerAsSalon?: [
			{ salon: ValueTypes["CreateSalon"] | Variable<any, string> },
			ValueTypes["RegisterResponse"]
		];
		registerAsClient?: [
			{ client: ValueTypes["CreateClient"] | Variable<any, string> },
			ValueTypes["RegisterResponse"]
		];
	...
	["SalonClientOps"]: AliasType<{
		createVisit?: [
			{ visit: ValueTypes["CreateVisitFromClient"] | Variable<any, string> },
			ValueTypes["VisitResponse"]
		];
		sendMessage?: [
			{ message: ValueTypes["MessageInput"] | Variable<any, string> },
	...
	["ClientOps"]: AliasType<{
		update?: [
			{ client: ValueTypes["UpdateClient"] | Variable<any, string> },
			ValueTypes["RegisterResponse"]
		];
	...
	["MessageSender"]: AliasType<{
		["...on SalonClient"]: ValueTypes["SalonClient"];
...
export type ResolverInputTypes = {
	["Dated"]: AliasType<{
		...
		["...on SalonProfile"]?: Omit<
			ResolverInputTypes["SalonProfile"],
			keyof ResolverInputTypes["Dated"]
		>;
		["...on SalonClient"]?: Omit<
			ResolverInputTypes["SalonClient"],
			keyof ResolverInputTypes["Dated"]
		>;
		...
		["...on MessageThread"]?: Omit<
			ResolverInputTypes["MessageThread"],
			keyof ResolverInputTypes["Dated"]
		>;
	...
	["Owned"]: AliasType<{
		...
		["...on SalonProfile"]?: Omit<
			ResolverInputTypes["SalonProfile"],
			keyof ResolverInputTypes["Owned"]
		>;
		__typename?: boolean | `@${string}`;
	}>;
	["StringId"]: AliasType<{
		...
		["...on SalonProfile"]?: Omit<
			ResolverInputTypes["SalonProfile"],
			keyof ResolverInputTypes["StringId"]
		>;
		["...on SalonClient"]?: Omit<
			ResolverInputTypes["SalonClient"],
			keyof ResolverInputTypes["StringId"]
	...
	["SalonOps"]: AliasType<{
		...
		update?: [
			{ salon: ResolverInputTypes["UpdateSalon"] },
	...
	["SalonClient"]: AliasType<{
		...
		visits?: [
			{ filterDates: ResolverInputTypes["DateFilter"]; salonId?: string | undefined | null },
			ResolverInputTypes["Visit"]
		];
		_id?: boolean | `@${string}`;
		createdAt?: boolean | `@${string}`;
		updatedAt?: boolean | `@${string}`;
	...
	["SalonQuery"]: AliasType<{
		...
		analytics?: [
			{ filterDates: ResolverInputTypes["DateFilter"] },
			ResolverInputTypes["SalonAnalytics"]
		];
	...
	["VisitOps"]: AliasType<{
		update?: [
			{ visit: ResolverInputTypes["UpdateVisitFromAdmin"] },
			ResolverInputTypes["VisitResponse"]
		];
		delete?: boolean | `@${string}`;
		__typename?: boolean | `@${string}`;
	}>;
	...
	["UserOps"]: AliasType<{
		...
		registerAsClient?: [
			{ client: ResolverInputTypes["CreateClient"] },
			ResolverInputTypes["RegisterResponse"]
		];
	...
	["ClientOps"]: AliasType<{
		update?: [
			{ client: ResolverInputTypes["UpdateClient"] },
			ResolverInputTypes["RegisterResponse"]
		];
...
export type ModelTypes = {
	["Dated"]:
		| ModelTypes["User"]
		| ModelTypes["SalonProfile"]
		| ModelTypes["SalonClient"]
		| ModelTypes["Visit"]
		| ModelTypes["Service"]
		| ModelTypes["Message"]
		| ModelTypes["MessageThread"]
		| ModelTypes["Client"];
