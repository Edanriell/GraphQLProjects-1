...
export type ValueTypes = {
	...
	["UserMutation"]: AliasType<{
		postQuestion?: [
			{ createQuestion: ValueTypes["CreateQuestion"] | Variable<any, string> },
			boolean | `@${string}`
		];
		postAnswer?: [
			{ createAnswer: ValueTypes["CreateAnswer"] | Variable<any, string> },
			boolean | `@${string}`
		];
...
export type ResolverInputTypes = {
	["Message"]: AliasType<{
		...
		["...on Question"]?: Omit<
			ResolverInputTypes["Question"],
			keyof ResolverInputTypes["Message"]
		>;
	...
	["UserMutation"]: AliasType<{
		postQuestion?: [
			{ createQuestion: ResolverInputTypes["CreateQuestion"] },
			boolean | `@${string}`
		];
