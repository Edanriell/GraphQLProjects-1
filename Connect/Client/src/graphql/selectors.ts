...
export type SalonType = FromSelector<typeof SalonProfileSelector, "SalonProfile">;
...
export const FullSalonMeQuerySelector = Selector("SalonQuery")({
	...
	visits: [{ filterDates: { from: new Date().toISOString() } }, VisitSalonSelector],
	clients: SalonClientForSalonSelector
});

export type FullSalonMeQueryType = FromSelector<typeof FullSalonMeQuerySelector, "SalonQuery">;
...
export const SalonClientDetailForClientSelector = Selector("SalonClient")({
	...
	visits: [{ filterDates: { from: new Date().toISOString() } }, VisitClientSelector]
});
